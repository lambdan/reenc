...
input_path = '/Volumes/Videos/' # folder with videos to batch through (also goes through subfolders)
...
ot = 'other-transcode' # path to other-transcode.bat (Windows is great, isn't it).. on unix i think you can just change this line to ` ot = 'other-transcode' ` ?
ot_settings = '--crop auto --vt --10-bit --hevc' # these are passed to other-transcode
